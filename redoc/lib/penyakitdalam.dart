...
import 'package:redoc/antrian/antrianPDalam.dart';
...
class PenyakitDalam extends StatefulWidget {
  const PenyakitDalam({Key? key}) : super(key: key);

  @override
  State<PenyakitDalam> createState() => _PenyakitDalamState();
}

class _PenyakitDalamState extends State<PenyakitDalam> {
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  child: Image(image: AssetImage('assets/dalam2.png')),
                ),
                Column(
  ...
  upData() async {
    ...
    var storyRef = firestore.collection('dokterp.dalam').doc(user!.uid).set({
      'antrian': l[0] + 1,
