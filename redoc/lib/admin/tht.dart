...
class THTAdmin extends StatefulWidget {
  const THTAdmin({Key? key}) : super(key: key);

  @override
  State<THTAdmin> createState() => _THTAdminState();
}

class _THTAdminState extends State<THTAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("dokterTHT").get().then((value) {
