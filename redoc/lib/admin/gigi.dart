...
class GigiAdmin extends StatefulWidget {
  const GigiAdmin({Key? key}) : super(key: key);

  @override
  State<GigiAdmin> createState() => _GigiAdminState();
}

class _GigiAdminState extends State<GigiAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("doktergigi").get().then((value) {
