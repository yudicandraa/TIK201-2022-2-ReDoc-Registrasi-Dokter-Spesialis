...
class JantungAdmin extends StatefulWidget {
  const JantungAdmin({Key? key}) : super(key: key);

  @override
  State<JantungAdmin> createState() => _JantungAdminState();
}

class _JantungAdminState extends State<JantungAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("dokterjantung").get().then((value) {
