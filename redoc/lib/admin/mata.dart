...
class MataAdmin extends StatefulWidget {
  const MataAdmin({Key? key}) : super(key: key);

  @override
  State<MataAdmin> createState() => _MataAdminState();
}

class _MataAdminState extends State<MataAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("doktermata").get().then((value) {
