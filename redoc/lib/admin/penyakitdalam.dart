...
class PDalamAdmin extends StatefulWidget {
  const PDalamAdmin({Key? key}) : super(key: key);

  @override
  State<PDalamAdmin> createState() => _PDalamAdminState();
}

class _PDalamAdminState extends State<PDalamAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("dokterp.dalam").get().then((value) {
