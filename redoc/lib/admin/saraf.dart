...
class SarafAdmin extends StatefulWidget {
  const SarafAdmin({Key? key}) : super(key: key);

  @override
  State<SarafAdmin> createState() => _SarafAdminState();
}

class _SarafAdminState extends State<SarafAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("doktersaraf").get().then((value) {
