...
class ParuAdmin extends StatefulWidget {
  const ParuAdmin({Key? key}) : super(key: key);

  @override
  State<ParuAdmin> createState() => _ParuAdminState();
}

class _ParuAdminState extends State<ParuAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("dokterparu").get().then((value) {
