...
class AnakAdmin extends StatefulWidget {
  const AnakAdmin({Key? key}) : super(key: key);

  @override
  State<AnakAdmin> createState() => _AnakAdminState();
}

class _AnakAdminState extends State<AnakAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("dokteranak").get().then((value) {
