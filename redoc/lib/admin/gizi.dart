...
class GiziAdmin extends StatefulWidget {
  const GiziAdmin({Key? key}) : super(key: key);

  @override
  State<GiziAdmin> createState() => _GiziAdminState();
}

class _GiziAdminState extends State<GiziAdmin> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection("doktergizi").get().then((value) {
