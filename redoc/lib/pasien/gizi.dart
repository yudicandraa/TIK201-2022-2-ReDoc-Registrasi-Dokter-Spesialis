...
class DaftarGizi extends StatefulWidget {
  const DaftarGizi({Key? key}) : super(key: key);

  @override
  State<DaftarGizi> createState() => _DaftarGiziState();
}

class _DaftarGiziState extends State<DaftarGizi> {
