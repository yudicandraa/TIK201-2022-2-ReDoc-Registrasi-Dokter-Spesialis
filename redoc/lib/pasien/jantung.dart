...
class DaftarJantung extends StatefulWidget {
  const DaftarJantung({Key? key}) : super(key: key);

  @override
  State<DaftarJantung> createState() => _DaftarJantungState();
}

class _DaftarJantungState extends State<DaftarJantung> {
