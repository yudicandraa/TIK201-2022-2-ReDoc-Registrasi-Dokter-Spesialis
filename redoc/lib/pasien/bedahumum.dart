...
class DaftarBedahUmum extends StatefulWidget {
  const DaftarBedahUmum({Key? key}) : super(key: key);

  @override
  State<DaftarBedahUmum> createState() => _DaftarBedahUmumState();
}

class _DaftarBedahUmumState extends State<DaftarBedahUmum> {
