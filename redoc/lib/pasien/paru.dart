...
class DaftarParu extends StatefulWidget {
  const DaftarParu({Key? key}) : super(key: key);

  @override
  State<DaftarParu> createState() => _DaftarParuState();
}

class _DaftarParuState extends State<DaftarParu> {
