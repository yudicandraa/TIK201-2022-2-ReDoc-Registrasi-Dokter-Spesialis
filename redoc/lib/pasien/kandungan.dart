...
class DaftarKandungan extends StatefulWidget {
  const DaftarKandungan({Key? key}) : super(key: key);

  @override
  State<DaftarKandungan> createState() => _DaftarKandunganState();
}

class _DaftarKandunganState extends State<DaftarKandungan> {
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  child: Image(image: AssetImage('assets/kandungan2.png')),
                ),
                Column(
