...
class DaftarJiwa extends StatefulWidget {
  const DaftarJiwa({Key? key}) : super(key: key);

  @override
  State<DaftarJiwa> createState() => _DaftarJiwaState();
}

class _DaftarJiwaState extends State<DaftarJiwa> {
