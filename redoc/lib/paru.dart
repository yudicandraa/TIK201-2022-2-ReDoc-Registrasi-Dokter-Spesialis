...
import 'package:redoc/antrian/antrianParu.dart';
...
class PenyakitParu extends StatefulWidget {
  const PenyakitParu({Key? key}) : super(key: key);

  @override
  State<PenyakitParu> createState() => _PenyakitParuState();
}

class _PenyakitParuState extends State<PenyakitParu> {
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  child: Image(image: AssetImage('assets/paru2.png')),
                ),
                Column(
  ...
  upData() async {
    ...
    var storyRef = firestore.collection('dokterparu').doc(user!.uid).set({
      'antrian': l[0] + 1,
