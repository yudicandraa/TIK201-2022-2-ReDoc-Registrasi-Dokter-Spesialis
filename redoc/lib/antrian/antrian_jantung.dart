...
class AntrianJantung extends StatefulWidget {
  const AntrianJantung({Key? key}) : super(key: key);

  @override
  State<AntrianJantung> createState() => _AntrianJantungState();
}

class _AntrianJantungState extends State<AntrianJantung> {
